...
class Methods {
  ...
  public static void ReinosGameplay(Ejercito[][] tablero, List<Ejercito> todosLosSoldados, String Reino1) {
  ...
  public static void pauseMenu2(Ejercito[][] tablero, String Reino1) {
    Scanner sc = new Scanner(System.in);
  ...
  public static void crearTableroReinos(Ejercito[][] tablero, String Reino1) {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      for (int j = 0; j < 10; j++) {
        if (tablero[i][j] == null) {
          ...
          if (tablero[i][j].getTeam() == 1) {
            System.out.print("|" + ANSI_RED + tablero[i][j].getInitial() + ANSI_RESET + "|");
          } else {
            System.out.print("|" + ANSI_BLUE + tablero[i][j].getInitial() + ANSI_RESET + "|");
          }
        }
      }
      System.out.println();
